        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <p class="text-center custom-text-shadow fs-5" style="letter-spacing: 2.5px;">ကမ္ဘာဦးလူသားနှစ်ဦးကို အသက်သွင်းအနေဂဇာတင်ခဲ့တဲ့ထာဝရဘုရားဆိုတာ ယေရှုခရစ်တော် ဖြစ်ကြောင်း သင်သိပါသလား။ </p>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="10000">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <p class="text-center custom-text-shadow fs-5" style="letter-spacing: 2.5px;">ဘုရားဘုံမှလူ့ဘုံသို့ဆင်းသက်လာခဲ့သော ကယ်မည့်ဘုရားအပျိုသားသည် ယေရှုခရစ်တော် ဖြစ်ကြောင်း သင်သိပါသလား။</p>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="10000">
                <img loading="eager" src="<?= get_template_directory_uri(); ?>/includes/assets/images/slider-3.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <p class="text-center custom-text-shadow fs-5" style="letter-spacing: 2.5px;">လက်ရှိကမ္ဘာကြီးနှင့် နိဗ္ဗာန်ဘုံနှင့်ငရဲဘုံကို အုပ်စိုးနေသောဘုရားသည် ယေရှုခရစ်တော် ဖြစ်ကြောင်း သင်သိပါသလား။</p>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="10000">
                <img loading="eager" src="<?= get_template_directory_uri(); ?>/includes/assets/images/slider-4.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <p class="text-center custom-text-shadow fs-5" style="letter-spacing: 2.5px;">သေခြင်းမစ္စုမာရ်ကို အောင်သောဘုရားသည် ယေရှုခရစ်တော်ဖြစ်ကြောင်း သင်သိပါသလား။</p>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="10000">
                <img loading="eager" src="<?= get_template_directory_uri(); ?>/includes/assets/images/slider-5.png" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <p class="text-center custom-text-shadow fs-5" style="letter-spacing: 2.5px;">လူသားများ၏အပြစ်ကိုလွတ်၍ အပါယ်ငရဲမှ ကယ်တင်ရန် အပြစ်လွတ်ခြင်း အမိန့်ကို ထုတ်ခဲ့သောဘုရားသည် ယေရှုခရစ်တော်ဖြစ်ကြောင်း သင်သိပါသလား။</p>
                </div>
            </div>
        </div>
    ...
    <div class="position-relative">
        <div class="position-absolute top-50 start-50 translate-middle px-5 py-1 drop-shadow rounded-5 z-2 bg-white" style="background-color: #f4f7fc;">
            <div class="d-flex gap-5 ">
                <a href="" class="cursor-pointer text-decoration-none text-dark py-2">
                ...
                <a href="./rakhine" class="cursor-pointer text-decoration-none text-dark p-2">
                ...
                <a href="./shan" class="cursor-pointer text-decoration-none text-dark p-2">
                ...
                <a href="./mon" class="cursor-pointer text-decoration-none text-dark p-2">
    ...
    <div class="container pt-5 my-4 my-lg-5">
        ...
        <div class="row pt-3 mb-4 mb-lg-5 gx-5">
            ...
            <div class="col-12 col-md-7">
                <div>
                    ...
                    <a href="/about-us" class="btn btn-outline-success rounded-pill py-2 px-3">
                        Learn More
                    </a>
                </div>
            </div>
        ...
        <div class="mb-4 mb-lg-5 pt-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="./videos" class="btn btn-view-all fw-semibold px-0">
                    View All Videos
                </a>
            </div>
            <div class="row g-4 youtube">
        ...
        <div class="mb-4 mb-lg-5 pt-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="./articles" class="btn btn-view-all fw-semibold px-0">
                    View All Articles
                </a>
            </div>
            <div class="row g-4">
                ...
                ?>
                        <div class="col-12 col-md-6 col-lg-3">
                            ...
                            <a class="text-decoration-none text-dark" href="<?php the_permalink(); ?>">
                                <div class="card rounded-2 position-relative border-0 card-shadow h-100">
                                    <!-- Audio Icon Badge -->
        ...
        <div class="mb-4 mb-lg-5 pt-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="./audios" class="btn btn-view-all fw-semibold px-0">
                    View All Audios
                </a>
            </div>
