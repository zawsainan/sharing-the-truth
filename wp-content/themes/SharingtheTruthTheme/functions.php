...
function _tk_scripts()
{
	...
	wp_enqueue_style('_tk-bootstrap-wp', THEME_DIR_URI . '/includes/css/bootstrap.min.css');
	wp_enqueue_style('_tk-style-wp', THEME_DIR_URI . '/includes/css/style.css');
	...
	// load bootstrap js
	wp_enqueue_script('_tk-bootstrapjs', THEME_DIR_URI . '/includes/js/bootstrap.bundle.min.js', array('jquery'));
