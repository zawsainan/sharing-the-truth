...
<body>
    ...
    <div class="container">
        <div class="main-content">
            <div class="logo">
                <img src="<?php echo get_template_directory_uri(); ?>/includes/assets/images/rakhine.png" alt="">
            </div>

            <h1 class="main-title">COMING SOON</h1>
            <p class="subtitle">မင်္ဂလာပါ! ရခိုင် channel မှနွေးထွေးစွာကြိုဆိုပါ၏။</p>
            <p class="description">
                ရခိုင်ဘာသာစကားဖြင့် အကြောင်းအရာအသစ်များကို တင်ဆက်နိုင်ဖို့ ကျွန်တော်တို့ ကြိုးစားလျက် ရှိပါတယ်။ အသစ်တွေ ထွက်လာတဲ့အခါမှာ အဦးဆုံး သိရှိနိုင်ဖို့ စောင့်မျှော်ပေးပါဦးနော်။ </p>

            <div class="notify-section">
                <a href="/" type="submit" class="notify-btn">မူလစာမျက်နှာသို့</a>
                <div class="social-links">
                    <a href="#" class="social-link">
                        <img src="<?php echo get_template_directory_uri(); ?>/includes/assets/icons/facebook.svg" alt="">
                    </a>
                    <a href="#" class="social-link">
                        <img src="<?php echo get_template_directory_uri(); ?>/includes/assets/icons/tiktok.png" alt="">

                    </a>
                    <a href="#" class="social-link">
                        <img src="<?php echo get_template_directory_uri(); ?>/includes/assets/icons/youtube.png" alt="">
                    </a>
