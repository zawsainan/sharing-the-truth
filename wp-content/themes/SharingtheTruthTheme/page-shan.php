...
<body>
    ...
    <div class="container">
        <div class="main-content">
            <div class="logo">
                <img src="<?php echo get_template_directory_uri(); ?>/includes/assets/images/shan.png" alt="">
            </div>

            <h1 class="main-title">COMING SOON</h1>
            <p class="subtitle">မင်္ဂလာပါ! ရှမ်း channel မှနွေးထွေးစွာကြိုဆိုပါ၏။</p>
            <p class="description">
                ရှမ်းဘာသာစကားဖြင့် အကြောင်းအရာအသစ်များကို တင်ဆက်နိုင်ဖို့ ကျွန်တော်တို့ ကြိုးစားလျက် ရှိပါတယ်။ အသစ်တွေ ထွက်လာတဲ့အခါမှာ အဦးဆုံး သိရှိနိုင်ဖို့ စောင့်မျှော်ပေးပါဦးနော်။ </p>
